...
const {registerService} = require('../cache');

/**
 * Constants
 */

const CRAWLER_NAME = 'ML';
...
const logger = log4js.getLogger(`Crawler-${CRAWLER_NAME}`);

/**
 * Main crawler function
 * @param {object} options Crawler initialization parameters
 * @return {Promise} A promise that resolves to the fetched records
 */
...
registerService(CRAWLER_NAME, run);
